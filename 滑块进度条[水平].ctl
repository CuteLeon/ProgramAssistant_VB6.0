...
Private Sub BarWidthChange()
    Dim BarWiHe As Single
    Dim UpX As Integer
    Dim DownX As Integer
    UpX = 2
    DownX = UserControl.ScaleWidth - MoveButton.Width - 3
    If LargeChang <= MyMax Then
        BarWiHe = (LargeChang / (LargeChang + MyMax)) * (DownX - UpX)
    Else
        BarWiHe = (1 - (MyMax / (LargeChang + MyMax))) * (DownX - UpX)
    End If
    If BarWiHe < 30 Then BarWiHe = 30
    MoveButton.Width = BarWiHe
End Sub
